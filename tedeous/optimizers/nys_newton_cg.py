...
class NysNewtonCG(Optimizer):
    ...
    Args:
        grad_params (torch.Tensor): The gradient of the loss with respect to the model's parameters.
        params (torch.Tensor): The model's parameters.
        v (torch.Tensor): The vector to compute the Hessian-vector product with.
    ...
    Args:
        ...
        update (Tensor): The gradient update to be applied.
    ...
    def _set_param(self, params_data):
        """
    Sets the data of the model's parameters to the provided values.

    Args:
        params_data (list of torch.Tensor): A list of tensors containing the new data for the model's parameters.
