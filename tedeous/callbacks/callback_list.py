...
class CallbackList(Callback):
    ...
    def set_params(self, params):
        """
    Sets the parameters for this object and all its callbacks.
    ...
    This method is a hook that is called at the start of each epoch. It iterates
    over the list of callbacks and calls their `on_epoch_begin` method, passing
    the logs as an argument.

    Args:
        logs (dict, optional): A dictionary of logs. Defaults to an empty dictionary.
